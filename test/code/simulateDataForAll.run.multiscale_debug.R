...
## Example 1
##seed=225
##geno.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/geno10.dat'
##raw.dat.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/pheno.dat'
##sig0.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/alt.sig0'
##sig1.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/alt.sig1'
##read.depth.ratio=0.5
##over.dispersion=1/70/70/10
##multipleSig=1
##wavelet.preprocess=TRUE
##DESeq.preprocess=TRUE
##wd.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/alt/'
##output.dir.name='halfread.10ind'

## Example 2
##seed=206
##geno.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/geno6.dat'
##raw.dat.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/pheno.dat'
##sig0.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/alt.sig0'
##sig1.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/data/alt.sig1'
##read.depth.ratio=1
...
##DESeq.preprocess=TRUE
##wd.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v2/alt/'
##output.dir.name='fullread.6ind'

## Example 3
seed=576
geno.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v1/data/geno10.dat'
raw.dat.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v1/data/pheno.dat'
sig0.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v1/data/alt.sig0'
sig1.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v1/data/alt.sig1'
read.depth.ratio=0.5
over.dispersion=1/70/70/10
multipleSig=1
wavelet.preprocess=TRUE
DESeq.preprocess=TRUE
wd.path='/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_manyQTLfinal_v1/alt/'
output.dir.name='halfread.10ind'
...
## for example1
##save(phenoD, genoD, res, file = "/mnt/lustre/home/shim/multiscale_analysis/debug/bugInsimu/example1/data.Robj")

## for example2
##save(phenoD, genoD, res, file = "/mnt/lustre/home/shim/multiscale_analysis/debug/bugInsimu/example2/data.Robj")

## for example3
##save(phenoD, genoD, res, file = "/mnt/lustre/home/shim/multiscale_analysis/debug/bugInsimu/example3/data.Robj")
