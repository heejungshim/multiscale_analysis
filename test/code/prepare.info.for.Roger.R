...
out.path = '/mnt/lustre/home/shim/multiscale_analysis/test/code/'
...
save("effect.mean", "effect.sd", "xmin", file = paste0(out.path, file.name, ".Robj"))
cat(sort(union(wh.high + xmin, wh.low + xmin)), file = paste0(out.path, file.name, ".sigposi"))
