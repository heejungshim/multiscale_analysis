## `preprocess.wave.DESeq.N.run.multiscale.on.roger.ATACseq.each.case.R' is to run preprocess.wave.DESeq.N.run.multiscale.on.roger.ATACseq.R for a particular site.
##
##
## chr : chromosome
