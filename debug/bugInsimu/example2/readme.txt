In simulation with effect size from multiseq (see compareWaveQTLandmultiseq_manydsQTL_final.org): case with `fullread.6ind' and `seed=206'
See the scipt `simulateDataForAll.run.multiscale_debug.R' in ~/multiscale_analysis/test/code/

phenoD : phenotype data for 6 individuls on 1024bp
...
List of 7
 ...
 $ fitted.g          :List of 11
  ...
  .. ..$ sd  : num [1:5] 0 897 1795 3589 7178
