...
## Aim : run DESeq2 with 100bp windows. I'll focus on `Copper.2048.both'. 
##
...
## output min.pval
write.table(min.pval, file = paste0(output.dir.path, "/DESeq2.min.pval.", filter.cut, ".txt"), quote= FALSE, row.names = FALSE, col.names = FALSE)

## output pval
write.table(pval.filtered, file = paste0(output.dir.path, "/DESeq2.all.pval.", filter.cut, ".txt"), quote= FALSE, row.names = FALSE, col.names = FALSE)
