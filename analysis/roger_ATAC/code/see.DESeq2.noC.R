...
## output min.pval
write.table(min.pval, file = paste0(output.dir.path, "/DESeq2.noC.min.pval.", filter.cut, ".txt"), quote= FALSE, row.names = FALSE, col.names = FALSE)

## output pval
write.table(pval.filtered, file = paste0(output.dir.path, "/DESeq2.noC.all.pval.", filter.cut, ".txt"), quote= FALSE, row.names = FALSE, col.names = FALSE)
