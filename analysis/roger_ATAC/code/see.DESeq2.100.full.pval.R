...
pval.deseq.100.0 = rep(NA, num.tests)
ix.final = (1:num.tests)[-del.ix.deseq]
pval.deseq.100.0[ix.final] = pval.deseq
length(del.ix.deseq)
## 114617
...
num.tests = length(deseq.alt)
pval.deseq.full.0 = rep(NA, num.tests)
ix.final = (1:num.tests)[-del.ix.deseq]
pval.deseq.full.0[ix.final] = pval.deseq
length(del.ix.deseq)
## 11565
...
save("pval.deseq.100.0", "pval.deseq.full.0", file = out.path)
