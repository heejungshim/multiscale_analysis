...
pdf("hist.statistic.pval.DESeq2.debug.discrete.pdf")
...
setwd("/mnt/lustre/home/shim/multiscale_analysis/analysis/roger_ATAC/fig/DESeqdebug/")
pdf("hist.statistic.pval.DESeq2.debug.discrete.pooling.pdf")
...
deseq.alt = as.numeric(as.matrix(read.table(paste0("/mnt/lustre/home/shim/multiscale_analysis/analysis/roger_ATAC/run/deseq/", treatment, ".", siteSize, ".", strand, ".", 300, ".alt.run/output/DESeq2.all.pval.", filter.cut, ".txt"))))
deseq.null = as.numeric(as.matrix(read.table(paste0("/mnt/lustre/home/shim/multiscale_analysis/analysis/roger_ATAC/run/deseq/", treatment, ".", siteSize, ".", strand, ".", 300, ".null.run/output/DESeq2.all.pval.", filter.cut, ".txt"))))
