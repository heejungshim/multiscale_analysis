...
pdf("distReadCountVio.pdf")
vioplot(both.rc[both.rc <= 6000], msOnly.rc[msOnly.rc <= 6000], all.rc[all.rc <=6000], names = c("multiseq and WaveQTL", "only multiseq", "all sites"), col="gold")
title(ylab ="read count")
dev.off()
