...
hist(wave.null[[1]], main="null Wavelet (4 full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.null[[1]], main="null multiscale (4 full)", breaks = 47, xlim =c(minval, maxval))
hist(wave.alt[[1]], main="alt Wavelet (4 full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.alt[[1]], main="alt multiscale (4 full)", breaks = 47, xlim =c(minval, maxval))
...
hist(wave.null[[2]], main="null Wavelet (4 2full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.null[[2]], main="null multiscale (4 2full)", breaks = 47, xlim =c(minval, maxval))
hist(wave.alt[[2]], main="alt Wavelet (4 2full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.alt[[2]], main="alt multiscale (4 2full)", breaks = 47, xlim =c(minval, maxval))
...
hist(wave.null[[3]], main="null Wavelet (4 4full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.null[[3]], main="null multiscale (4 4full)", breaks = 47, xlim =c(minval, maxval))
hist(wave.alt[[3]], main="alt Wavelet (4 4full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.alt[[3]], main="alt multiscale (4 4full)", breaks = 47, xlim =c(minval, maxval))
...
legend(0.6, 0.3, c("multiscale 4 full", "wave 4 full", "multiscale 4 2full", "wave 4 2full","multiscale 4 4full", "wave 4 4full") , col = c("red", "blue", "red", "blue", "red", "blue"), lty = c("solid", "solid", "dashed", "dashed", "dotdash", "dotdash"), text.col = "black",merge = FALSE, bg = "white")
