...
output.path = "/mnt/lustre/home/shim/multiscale_analysis/analysis/simulation/sample_size/simulation_footprint/sum/logLR.overS.RD.10ind.Robj"
...
ROC.file.name = "logLR_ROC_overS_RD_10ind.pdf"
...
hist.file.name = "logLR_hist_overS_RD_10ind.pdf"
...
hist(wave.null[[1]], main="null Wavelet (10 full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.null[[1]], main="null multiscale (10 full)", breaks = 47, xlim =c(minval, maxval))
hist(wave.alt[[1]], main="alt Wavelet (10 full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.alt[[1]], main="alt multiscale (10 full)", breaks = 47, xlim =c(minval, maxval))
...
hist(wave.null[[2]], main="null Wavelet (10 2full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.null[[2]], main="null multiscale (10 2full)", breaks = 47, xlim =c(minval, maxval))
hist(wave.alt[[2]], main="alt Wavelet (10 2full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.alt[[2]], main="alt multiscale (10 2full)", breaks = 47, xlim =c(minval, maxval))
...
hist(wave.null[[3]], main="null Wavelet (10 4full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.null[[3]], main="null multiscale (10 4full)", breaks = 47, xlim =c(minval, maxval))
hist(wave.alt[[3]], main="alt Wavelet (10 4full)", breaks = 47, xlim =c(minval, maxval))
hist(ms.alt[[3]], main="alt multiscale (10 4full)", breaks = 47, xlim =c(minval, maxval))
...
legend(0.6, 0.3, c("multiscale 10 full", "wave 10 full", "multiscale 10 2full", "wave 10 2full","multiscale 10 4full", "wave 10 4full") , col = c("red", "blue", "red", "blue", "red", "blue"), lty = c("solid", "solid", "dashed", "dashed", "dotdash", "dotdash"), text.col = "black",merge = FALSE, bg = "white")
