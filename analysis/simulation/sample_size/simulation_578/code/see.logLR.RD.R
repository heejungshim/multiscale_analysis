...
title.name = c("full", "2full", "4full")
#title.name = c("half", "full", "2full")

case.name = c(paste0("fullread.", numIND, "ind.over"), paste0("2fullread.", numIND, "ind.over"), paste0("4fullread.", numIND, "ind.over"))
#case.name = c(paste0("halfread.", numIND, "ind.over"), paste0("fullread.", numIND, "ind.over"), paste0("2fullread.", numIND, "ind.over"))
...
legend(0.7, 0.25, c(paste0("multiscale ", numIND), paste0("Wavelets ", numIND), title.name) , col = c("red", "blue", "black", "black", "black"), lty = c("solid", "solid", "solid", "dashed", "dotdash" ), text.col = "black",merge = FALSE, bg = "white")
